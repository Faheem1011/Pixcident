...
const Donate: React.FC = () => {
    ...
    return (
        <div className="bg-brand-black min-h-screen pt-24 pb-24 px-6">
            <SEO
                title="Donate - Support R&D"
                description="Support Pixcident's vision to build tools for the open-source creative community. Help us remain independent."
            />
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {DONATION_TIERS.map((tier) => (
                        <div
                            key={tier.name}
                            className={`relative p-8 rounded-xl border transition-all cursor-pointer ${selectedAmount === tier.amount
                        ...
                        >
                            ...
                            <button className={`w-full py-3 rounded font-bold uppercase tracking-wider transition-colors ${selectedAmount === tier.amount
