            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-500">hello@pixcident.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="p-3 bg-zinc-900 rounded-lg text-brand-orange">
                ...
                <div>
                  ...
                  <p className="text-zinc-500">Global Digital Studio<br />Based in the Cloud</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <AnimatePresence mode="wait">
                {formState === 'success' ? (
                    ...
                    >
                        ...
                        <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Project Type</label>
                        <select className="bg-zinc-900 border border-zinc-800 text-white px-4 py-3 rounded focus:outline-none focus:border-brand-orange transition-colors">
                        ...
                        <button 
                            ...
                            className="w-full bg-brand-orange text-white font-bold py-4 rounded hover:bg-orange-600 transition-colors uppercase tracking-widest flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
